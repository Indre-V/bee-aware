...
- The second part of the home page is the list of pollinators with the background colour. The content layout is very simple and self explanatory. This part intends to educate the user and encourage them to continue reading other parts of the webpage. I have used unicode to generate the characters instead of writing.
